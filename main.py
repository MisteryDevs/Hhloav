...
BOT_TOKEN = os.getenv("BOT_TOKEN", "6956731651:AAEMfetOAnm_LbnGrS_4z8GimAVjUDsNz8U")  # set in Render env
...
# Force join channels (username or channel id)
FORCE_JOIN1 = os.getenv("FORCE_JOIN1", "@Ur_rishu_143")
FORCE_JOIN2 = os.getenv("FORCE_JOIN2", "@Vip_robotz")

PORT = int(os.getenv("PORT", os.getenv("RENDER_EXTERNAL_PORT", "10000")))
...
# ---------------- BOT SETUP ----------------
if not BOT_TOKEN:
    logger.error("BOT_TOKEN is not set. Please set BOT_TOKEN in environment variables.")
    raise SystemExit(1)
